export const data = {
  ...
  data: {
    description:
    "The client's office needs IT and Network infrastructure installed for their IT equipment.",
    ...
    children: [
      {
        ...
        data: {
          name: "Site visit",
          description:
            "Visit the office location to assess the IT and network infrastructure requirements and layout.",
          dueDate: "2023-12-02",
          estimatedCost: 1000,
        },
      },
      {
        ...
        data: {
          ...
          description:
            "Install network points from all the work stations to the server room where the network cabinet will be.",
          dueDate: "2023-12-13",
          children: [
            {
              type: "Task",
            ...
            },
            {
              ...
              data: {
                ...
                description:
                  "Procure routers, switches, and cables and have it delivered to the IT workshop.",
                dueDate: "2023-12-06",
                estimatedCost: 25000,
              },
            },
            {
              ...
              data: {
                ...
                description:
                  "Install network points from the server room to all the required work stations.",
                dueDate: "2023-12-13",
                children: [
                  {
                    type: "Task",
                    data: {
                      name: "Pull wires",
                      description:
                        "Pull wires from the server room to all the required work stations.",
                      dueDate: "2023-12-11",
                      estimatedCost: 2000,
                    },
                  },
                  {
                    ...
                    data: {
                      ...
                      description:
                        "Terminate each network point at the client and server room side.",
                      dueDate: "2023-12-13",
                      estimatedCost: 1000,
                    },
                  },
      ...
      },
      {
        ...
        data: {
          ...
          description:
            "The client's office needs workstation computers and phones for each employee.",
          dueDate: "2023-12-20",
          children: [
            {
              type: "Task",
              data: {
                ...
                description:
                  "Procure the required computers and phones and have it delivered to the IT workshop.",
                dueDate: "2023-12-08",
                estimatedCost: 50000,
              },
            },
            {
              ...
              data: {
                ...
                description:
                  "Configure the procured computers and phones according to the requirements.",
                dueDate: "2023-12-13",
                estimatedCost: 2000,
              },
            },
            {
              ...
              data: {
                ...
                description:
                  "Install all the computers and phones at the client office.",
                dueDate: "2023-12-20",
                estimatedCost: 2000,
              },
            },
